...
| [ADR-0015](0015-p6-6-provider-neutral-repeatability-metric.md) | Accepted | P6.6 separates provider cache variance from prompt-bound aggregate workload repeatability |
